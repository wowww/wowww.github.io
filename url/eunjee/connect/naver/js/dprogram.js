...
$(function(){
    var idx = 0;
    var $indicator = $(".yeogsam>.slides-pagination>li>a");
    var $slide = $(".yeogsam .slides-container");
    var $explan = $(".yeogsam .slides-explan>li>p");
    ...
    $(".yeogsam .slides-prev").on("click",function(evt){
         evt.preventDefault();
        if(idx>0){
            idx--;
        }else{
        ...
        if(idx<3){
            ...
            $indicator.eq(6).parent().addClass("on").siblings().removeClass("on");  
            $explan.eq(6).parent().addClass("on").siblings().removeClass("on");
    ...
    $(".yeogsam .slides-next").on("click",function(evt){
         evt.preventDefault();
        if(idx<20){
            idx++;
        }else{
...
$(function(){
    var idx = 0;
    var $indicator = $(".wangsiblie>.slides-pagination>li>a");
    var $slide = $(".wangsiblie .slides-container");
    var $explan = $(".wangsiblie .slides-explan>li>p");
    ...
    $(".wangsiblie .slides-prev").on("click",function(evt){
         evt.preventDefault();
        if(idx>0){
            idx--;
        }else{
        ...
        }else if(idx>11 && idx<18){
            $indicator.eq(2).parent().addClass("on").siblings().removeClass("on");  
            $explan.eq(2).parent().addClass("on").siblings().removeClass("on");  
        }else if(idx>17 && idx<24){
            $indicator.eq(3).parent().addClass("on").siblings().removeClass("on");  
            $explan.eq(3).parent().addClass("on").siblings().removeClass("on");  
        }else if(idx>23){
            $indicator.eq(4).parent().addClass("on").siblings().removeClass("on");  
    ...
    $(".wangsiblie .slides-next").on("click",function(evt){
         evt.preventDefault();
        if(idx<29){
            idx++;
        }else{
...
$(function(){
    ...
    var $box1 = $(".yeogsam_studio");
    var $box2 = $(".wangsimni_studio");
